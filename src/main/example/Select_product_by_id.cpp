...
unique_ptr<Select_plan> Select_product_by_id::plan(Global_object_store &global_object_store, int id) {
    ...
    unique_ptr<Condition> cond(new And_condition(new Greater_equals_condition(0, unique_ptr<Value>(new Int_value(12))), new Less_equals_condition(0, unique_ptr<Value>(new Int_value(68)))));
